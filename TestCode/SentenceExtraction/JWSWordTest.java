...
//   Let's make it easy for the user. So, rather than set pointers in 'Environment Variables' etc. let's allow the user to define exactly where they have put WordNet(s)
		String dir = "E:\\Program Files (x86)\\WordNet";
...
// all senses
		TreeMap<String, Double> 	scores2	=	lin.lin("mall", "center", "n");			// all senses
...
// specific senses
		//System.out.println("\nspecific pair\t=\t" + lin.lin("car", 1, "bus", 1, "n") + "\n");
// max.
		System.out.println("\nhighest score\t=\t" + lin.max("good", "nice", "a") + "\n");
